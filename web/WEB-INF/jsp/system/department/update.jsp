            ...
            <div class="box-body">
                <form id="form" role="form" method="post" onsubmit="return submitForm(this)">
                    ...
                    <div class="form-group">
                        <label>部门名称</label>
                        <input type="text" class="form-control" name="name" value="${department.name}" placeholder="名称">
                    </div>

                    <!-- textarea -->
                    <div class="form-group">
                        <label>部门描述</label>
                        <textarea class="form-control" rows="3" name="description" placeholder="描述">${department.description}</textarea>
                    </div>
...
<script type="text/javascript">
    function submitForm(obj) {
        ...
        $.post(
            "${pageContext.request.contextPath}/departmentAction_updateDepartment",
            {"did":obj.did.value, "name":obj.name.value, "description":obj.description.value},
            function (data) {
                if (data == "success") {
